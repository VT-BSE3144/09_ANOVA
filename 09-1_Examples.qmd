...
Note that while we don't get an R^2^ with non-linear least squares that our Residual standard error is an order of magnitude lower with non-linear regression!
